...
public:
  void render(const ofBaseDraws& drawable, float multiplyBy) {
    render(drawable, glm::vec4 { multiplyBy });
  }
  ...
  void render(PingPongFbo& fbo, float multiplyBy) {
    render(fbo, glm::vec4 { multiplyBy });
  }
